...
static bool ggml_thread_apply_priority(int32_t prio) {
    ...
    if (prio != GGML_SCHED_PRIO_LOW) {
        ...
        // n_threads > 4
        // THREAD_POWER_THROTTLING_STATE requires Windows 10 SDK (0x0A00) and
        // THREAD_POWER_THROTTLING_CURRENT_VERSION to be defined in the headers.
        // Rtools MinGW may not have it — guard defensively.
        #if _WIN32_WINNT >= 0x0A00 && defined(THREAD_POWER_THROTTLING_CURRENT_VERSION)
